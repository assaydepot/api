...
You can specify the authentication token on the query string using the `access_token` query parameter. For instance:

{% highlight bash %}
https://www.assaydepot.com/api/[resource].json?access_token=1234567890
{% endhighlight %}
...
{% highlight bash %}
https://www.assaydepot.com/api/providers.json?q=[query term(s)]
{% endhighlight %}

For example, to search for vendors that match the term "antibody", you would use the url:

{% highlight bash %}
https://www.assaydepot.com/api/providers.json?q=antibody
{% endhighlight %}
...
{% highlight bash %}
https://www.assaydepot.com/api/wares.json?q=[query term(s)]
{% endhighlight %}

For example, to search for services that match the term "peptide", you would use the url:

{% highlight bash %}
https://www.assaydepot.com/api/wares.json?q=peptide
{% endhighlight %}
...
{% highlight bash %}
https://www.assaydepot.com/api/wares.json?q=fluid&facets[species][]=Human&page=1&per_page=2&access_token=1234567890
{% endhighlight %}
