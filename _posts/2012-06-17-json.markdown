...
{% highlight bash %}
https://app.scientist.com/api/[resource].json?access_token=1234567890
{% endhighlight %}
...
{% highlight bash %}
https://app.scientist.com/api/wares.json?q=fluid&facets[species][]=Human&page=1&per_page=2&access_token=1234567890
{% endhighlight %}
