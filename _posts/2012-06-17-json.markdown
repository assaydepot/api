...
Assay Depot's JSON API gives read-only access to vendors and services. To use the API you must [authenticate using OAuth2](/api/oauth2).
...
The API requires the user to authenticate. To use the API you must [authenticate using OAuth2](/api/oauth2). Assay Depot supports both Authorization Code and Client Credential workflows.
