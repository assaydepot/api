...
{#vendor-search}### Vendor Search Query
...
{#vendor-search-results}### Vendor Search Return Value
This will return:
...
{#vendor-detail-results}### Vendor Details Return Value
This will return:
...
{#service-search}### Service Search Query
Search queries take the form:
...
{#service-search-results}### Service Search Return Value
This will return:
...
{#service-detail-results}### Service Details Return Value
This will return:
