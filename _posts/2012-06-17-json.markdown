...
<table>
  <tbody>
    ...
    <tr>
      <td>facets</td>
      <td>nil</td>
      <td>You can refine the result set by specifying facet values. See the <a href="#vendor-search-facets">facets section</a> for more information.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      <td>facets</td>
      <td>nil</td>
      <td>You can refine the result set by specifying facet values. See the <a href="#service-search-facets">facets section</a> for more information.</td>
    </tr>
  </tbody>
</table>
